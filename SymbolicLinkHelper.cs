...
//This whole file is select parts from:
...
namespace TorrentFileCopier
{
    ...
    public static class SymbolicLinkHelper
    {
        ...
        /// <exception cref="IOException">Thrown when the specified path does not exist, is invalid, or some other error occurs</exception>        
